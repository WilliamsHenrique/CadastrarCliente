...
public abstract class GenericDAO<T extends Persistente, S> implements IGenericDAO<T, Serializable> {
    ...
    public abstract void excluir(String valor);

    public abstract void finalizarVenda(Venda venda) throws TipoChaveNaoEncontradaException;
}
